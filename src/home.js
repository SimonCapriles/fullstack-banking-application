...
function CustomCard() {
    ...
    return (
        <Card
            ...
            body={(
                <svg color={theme.txtcolor} aria-hidden="true" data-prefix="far" data-icon="university"
                     className="svg-inline--fa fa-university fa-w-16" xmlns="http://www.w3.org/2000/svg"
                     viewBox="0 0 512 512">
